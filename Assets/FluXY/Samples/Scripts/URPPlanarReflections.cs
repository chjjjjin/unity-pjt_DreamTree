...
{
    [ExecuteAlways]
    public class URPPlanarReflections : MonoBehaviour
    {
#if FLUXY_URP
        [Serializable]
        ...
        private void UpdateReflectionCamera(Camera realCamera)
        {
            ...
            if (target != null)
            {
                ...
                normal = Vector3.up;//target.transform.up;
            }
        ...
        private void PlanarReflectionTexture(Camera cam)
        {
            if (_reflectionTexture == null)
            {
                ...
                _reflectionTexture = RenderTexture.GetTemporary(res.x, res.y, 16, RenderTextureFormat.Default);
            }
